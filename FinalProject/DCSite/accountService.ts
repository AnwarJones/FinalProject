namespace DCSiteApp.Services {
    export class AccountService {
        ...
        storeUserInfo(userInfo) {
            ...
            // store claims
            for (let prop in userInfo) {//walk through a tokens information and if it starts with "claim_" then its a claim that can be passed out and stores the information in session storage
